...
export function InstallerOverview(props: Props) {
  ...
  return <section className="installer-page" aria-labelledby="installer-overview-title">
    ...
    <section className="installer-section"><SectionTitle icon={<Router size={19} />} title="基础设施入口" /><div className="installer-route-list"><RouteButton icon={<Router size={19} />} title="网关与协议" detail={props.gateways.length + " 个网关 · " + (protocols.length + threads.length) + " 项已证实关系"} route="gateways" onNavigate={props.onNavigate} /><RouteButton icon={<LayoutPanelTop size={19} />} title="面板旋钮" detail={props.panels.length + " 个面板 · " + props.knobs.length + " 个旋钮"} route="panels" onNavigate={props.onNavigate} /><RouteButton icon={<ShieldAlert size={19} />} title="版本与诊断" detail={terminalRows.length + " 项能力终态"} route="diagnostics" onNavigate={props.onNavigate} /></div></section>
  </section>;
}
