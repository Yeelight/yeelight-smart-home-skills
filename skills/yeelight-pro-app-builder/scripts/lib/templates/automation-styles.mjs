...
.automation-icon { width: 44px; height: 44px; display: grid; place-items: center; border-radius: var(--radius-md); color: var(--color-muted); background: var(--automation-icon-bg); box-shadow: var(--shadow-inset-border); }
...
.automation-comparison-static { min-width: 0; display: grid; align-content: start; gap: 6px; color: var(--color-muted); font-size: 13px; }
.automation-comparison-static strong { min-height: 44px; display: flex; align-items: center; padding: 0 12px; border: 1px solid var(--color-border); border-radius: var(--radius-md); color: var(--color-heading); background: var(--color-neutral-100); font-weight: 650; }
.automation-condition-static { grid-column: 2 / 5; min-height: 52px; display: flex; align-items: center; justify-content: space-between; gap: var(--space-3); padding: 8px 12px; border: 1px solid var(--color-border); border-radius: var(--radius-md); color: var(--color-muted); background: var(--color-neutral-100); }
.automation-condition-static strong { color: var(--color-heading); font-variant-numeric: tabular-nums; }
...
.automation-guard-backdrop, .automation-delete-backdrop { position: fixed; inset: 0; z-index: 1000; display: grid; place-items: center; padding: var(--space-4); background: var(--yp-semantic-overlay-soft); }
