...
| --- | --- | --- | --- |
| `yeelight-smart-home` | `0.1.6` | `yeelight-home >= 0.1.7` | Agent Skill ZIP, Codex Plugin ZIP, Claude Skill ZIP, Copilot Skill ZIP |
...
- Latest release: https://github.com/Yeelight/yeelight-smart-home-skills/releases/tag/yeelight-skill-yeelight-smart-home-v0.1.6
- Release evidence: `releases/yeelight-smart-home/v0.1.6/`
- Checksums: `releases/yeelight-smart-home/v0.1.6/checksums.txt`
- Validation summary: `releases/yeelight-smart-home/v0.1.6/validation-summary.json`
...
```text
releases/yeelight-smart-home/v0.1.6/yeelight-smart-home-codex-plugin-v0.1.6.zip
```
...
```text
releases/yeelight-smart-home/v0.1.6/yeelight-smart-home-claude-skill-v0.1.6.zip
```
...
```text
releases/yeelight-smart-home/v0.1.6/yeelight-smart-home-copilot-skill-v0.1.6.zip
```
...
```text
releases/yeelight-smart-home/v0.1.6/yeelight-smart-home-agent-skill-v0.1.6.zip
```
...
```sh
cd releases/yeelight-smart-home/v0.1.6
...
```sh
node scripts/verify-publication-assets.mjs --skill yeelight-smart-home --version 0.1.6
```
