...
- 最新 Release：https://github.com/Yeelight/yeelight-smart-home-skills/releases/tag/yeelight-skill-yeelight-smart-home-v0.1.8
- 发布证据：`releases/yeelight-smart-home/v0.1.8/`
- 校验和：`releases/yeelight-smart-home/v0.1.8/checksums.txt`
- 验证摘要：`releases/yeelight-smart-home/v0.1.8/validation-summary.json`
